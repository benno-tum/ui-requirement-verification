...
\autocite{fieldwelsh2007}. With only 13 flow clusters, intervals are
...
\tightlist
\item
  \texttt{SINGLE\_REGION} for one localized area;
\item
  \texttt{MULTI\_REGION} for evidence distributed across several areas;
\item
  \texttt{WHOLE\_\allowbreak SCREEN\_\allowbreak OR\_\allowbreak TRANSITION} for screen-wide or temporal evidence; and
\item
  \texttt{NO\_\allowbreak VISIBLE\_\allowbreak REGION} when no localizable visible support exists.
\end{itemize}
